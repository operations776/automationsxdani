          ...
          {showHeader && (
            <div className="max-w-2xl mb-16">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                Everything is shipped and running, anonymised where it needs to be. Every demo is
                a working miniature: click around, watch it move. Yours would look like this.
              </p>
            </div>
          )}
